...
//   const shop_data_filter = subcategory_id
...
//                     {
//                       shop_data_filter.map((v) => (
//                         <div className="rounded position-relative fruite-item productData">
//                               <div className="fruite-img">
//                                 <img src={v.prodact_img.url} className="img-fluid  rounded-top" alt />
//                               </div>
...
//                                   <p className="text-dark fs-5 fw-bold mb-0">${v.price} / kg</p>
//                                 </div>
//                                 <Button type='primary'> <i className="fa fa-shopping-bag me-2 text-primary" /> Add to cart </Button>
        ...
        <div className="container py-5">
          ...
          <div className="row g-4 justify-content-center">
            {shop_data_filter.map((v) => (
              <div
                key={v.id}
                className="rounded position-relative fruite-item productData"
                onClick={() => handleProductClick(v.id)}
                style={{ cursor: 'pointer' }} // Add pointer cursor for clarity
              >
                <div className="fruite-img">
                  <img src={v.prodact_img.url} className="img-fluid rounded-top" alt={v.name} />
                </div>
                <div className="p-4">
                  <h4>{v.name}</h4>
                  <p>{v.discription}</p>
                  ...
                  <Button type="primary" onClick={(e) => { e.stopPropagation(); handleAddToCart(v.id); }}>
