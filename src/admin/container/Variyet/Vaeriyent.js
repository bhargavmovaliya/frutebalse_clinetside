...
function Vaeriyent(props) {
    ...
    const columns = [
        ...
        {
            field: 'variants_img',
            headerName: 'variants_img',
            renderCell: (params) => {
                console.log(params);

                if (params.row.variants_img && params.row.variants_img.url) {
                    return <img src={params.row.variants_img.url} alt={params.row.name} width={50} />;
                } else {
                    return null;
                }
            },
                            ...
                            <div>
                                ...
                                />
                                 <input
                                    ...
                                    name="variants_img"
                                    onBlur={handleBlur}
                                    onChange={(event) => setFieldValue("variants_img", event.target.files[0])}
                                />
                                {
                                    values.variants_img &&
                                    <img src={values.variants_img.url ? values.variants_img.url : URL.createObjectURL(values.variants_img)} alt={values.variants_img.name} width={50} />
